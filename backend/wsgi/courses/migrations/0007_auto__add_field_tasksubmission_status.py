...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskSubmission.status'
        db.add_column(u'courses_tasksubmission', 'status',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskSubmission.status'
        db.delete_column(u'courses_tasksubmission', 'status')
