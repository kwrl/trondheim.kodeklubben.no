...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tasks on 'Course'
        m2m_table_name = db.shorten_name(u'courses_course_tasks')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm[u'courses.course'], null=False)),
            ('task', models.ForeignKey(orm[u'courses.task'], null=False))
        ))
        db.create_unique(m2m_table_name, ['course_id', 'task_id'])


    def backwards(self, orm):
        # Removing M2M table for field tasks on 'Course'
        db.delete_table(db.shorten_name(u'courses_course_tasks'))
