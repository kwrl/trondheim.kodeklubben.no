...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskSubmission.submitted_by'
        db.add_column(u'courses_tasksubmission', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskSubmission.submitted_by'
        db.delete_column(u'courses_tasksubmission', 'submitted_by_id')
