...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registration.role'
        db.add_column(u'courses_registration', 'role',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registration.role'
        db.delete_column(u'courses_registration', 'role')
    ...
    models = {
        ...
        u'courses.registration': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'role': ('django.db.models.fields.PositiveIntegerField', [], {}),
