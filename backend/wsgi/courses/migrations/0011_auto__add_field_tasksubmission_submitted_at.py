...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskSubmission.submitted_at'
        db.add_column(u'courses_tasksubmission', 'submitted_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskSubmission.submitted_at'
        db.delete_column(u'courses_tasksubmission', 'submitted_at')
