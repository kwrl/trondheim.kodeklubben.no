...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.registration_start'
        db.alter_column(u'courses_course', 'registration_start', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Course.registration_end'
        db.alter_column(u'courses_course', 'registration_end', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Course.registration_start'
        db.alter_column(u'courses_course', 'registration_start', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Course.registration_end'
        db.alter_column(u'courses_course', 'registration_end', self.gf('django.db.models.fields.DateTimeField')())
