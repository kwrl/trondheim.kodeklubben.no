...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskSubmission'
        db.create_table(u'courses_tasksubmission', (
        ...
        db.send_create_signal(u'courses', ['TaskSubmission'])


    def backwards(self, orm):
        # Deleting model 'TaskSubmission'
        db.delete_table(u'courses_tasksubmission')
